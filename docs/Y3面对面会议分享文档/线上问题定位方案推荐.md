---
slug: /talks/production-debugging
title: 线上问题定位方案推荐
showLastUpdateAuthor: true
sidebar_position: 0
---

<span id="拉取线上存档至本地测试" className="legacy-anchor" />

### 拉取线上存档至本地测试 {#download-save}
在作者之家中拉取玩家存档
...
<span id="vscode开发助手远程执行代码" className="legacy-anchor" />

### vscode开发助手远程执行代码 {#remote-execution}
...
<span id="远程执行代码的另一个方案" className="legacy-anchor" />

### 远程执行代码的另一个方案 {#alternative-remote-execution}
