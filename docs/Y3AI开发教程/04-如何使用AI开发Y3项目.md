...
## 简介
本文主要介绍如何使用Claude Code CLI进行Y3项目开发，如果你使用的是其他Agent，下文配置的skill以及mcp需要自行查找相关的配置教程，流程上是可以互通共用的
...
2. 使用此visx文件重新安装开发助手https://docs.popo.netease.com/docs/cb8519e58f4c435e8df400437bfdbac0
...
Claude.md https://docs.popo.netease.com/docs/aec75f44de8b4dfa9a3cd13d5cbeb7de

UI适配规则.md https://docs.popo.netease.com/docs/0b609337ae004e91b1df45237dabed1c
...
2.然后我会向AI发送消息：“@游戏设计文档\初步设计.md，帮我根据这个设计文档实现代码”
